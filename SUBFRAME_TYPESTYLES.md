...
|----------------|------------|-------------|--------|-----------|------------------|----------------|
| **Heading 1** | heading.page | Google Sans | 500 | 67 | 101 | 0% |
| **Heading 2** | heading.section | Google Sans | 500 | 51 | 77 | 0% |
...
**Note:** Subframe doesn’t list Google Sans; use **Upload font** for it or pick another display font (e.g. Inter) for Heading 1–2 until you add it.
...
|-------|------|--------|------|-------------|----------------|
| heading.page | Google Sans | 500 | 67px (3xl) | 150% | 0% |
| heading.section | Google Sans | 500 | 51px (2xl) | 150% | 0% |
...
| meta.metric | Google Sans | 700 | 51px (2xl) | 120% | -2% |
