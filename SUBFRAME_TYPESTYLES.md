...
|----------------|------------|-------------|--------|-----------|------------------|----------------|
| **Heading 1** | heading.page | Plus Jakarta Sans | 500 | 67 | 101 | 0% |
| **Heading 2** | heading.section | Plus Jakarta Sans | 500 | 51 | 77 | 0% |
...
**Note:** Plus Jakarta Sans is available in Subframe (Google Fonts). Select it as the font for Heading 1–2 in Theme → Typography.
...
|-------|------|--------|------|-------------|----------------|
| heading.page | Plus Jakarta Sans | 500 | 67px (3xl) | 150% | 0% |
| heading.section | Plus Jakarta Sans | 500 | 51px (2xl) | 150% | 0% |
...
| meta.metric | Plus Jakarta Sans | 700 | 51px (2xl) | 120% | -2% |
